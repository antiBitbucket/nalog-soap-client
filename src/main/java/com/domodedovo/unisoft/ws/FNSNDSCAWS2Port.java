package com.domodedovo.unisoft.ws;
...
import com.domodedovo.unisoft.ws.fnsndscaws2.response.ObjectFactory;
...
@XmlSeeAlso({
        com.domodedovo.unisoft.ws.fnsndscaws2.request.ObjectFactory.class,
        ObjectFactory.class
})
public interface FNSNDSCAWS2Port {
    ...
    public NdsResponse2 ndsRequest2(
            @WebParam(name = "NdsRequest2", targetNamespace = "http://ws.unisoft/FNSNDSCAWS2/Request", partName =
                    "np_in")
                    NdsRequest2 npIn);
