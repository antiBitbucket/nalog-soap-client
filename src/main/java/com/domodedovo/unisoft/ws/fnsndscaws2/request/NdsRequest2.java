package com.domodedovo.unisoft.ws.fnsndscaws2.request;
...
public class NdsRequest2 {
    ...
    private List<NdsRequest2.NP> np;
    ...
    public static class NP {
        ...
        public boolean equals(Object o) {
            ...
            NP np = (NP) o;
            return Objects.equals(inn, np.inn) &&
                    Objects.equals(kpp, np.kpp) &&
                    Objects.equals(dt, np.dt);
        }

        @Override
        public int hashCode() {
            return Objects.hash(inn, kpp, dt);
        }
